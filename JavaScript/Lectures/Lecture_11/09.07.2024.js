...
// console.log(parseFloat("10.34343"));
// console.log(parseFloat("yes 10"));


console.log(Number.isInteger(123456576654433434332));

console.log(Number.isSafeInteger(9876987698798769876));
console.log(Number.isSafeInteger(987698769879876));
